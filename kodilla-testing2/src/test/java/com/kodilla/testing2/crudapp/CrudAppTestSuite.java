...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mfabijanczuk.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mikolaj.fabijanczuk@gmail.com");
    ...
    ///html/body/main/section[2]/div/form[6]/div/fieldset[1]
