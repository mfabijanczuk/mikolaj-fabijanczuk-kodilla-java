...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf0(){
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedBooksByUser = new ArrayList<Book>();
        LibraryUser libraryUser = new LibraryUser("Mikołaj", "Fabijańczuk", "890309");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedBooksByUser);
    ...
    public void testListBooksInHandsOf1(){
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedBooksByUser = generateListOfBooks(1);
        LibraryUser libraryUser = new LibraryUser("Mikołaj", "Fabijańczuk", "890309");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedBooksByUser);
    ...
    public void testListBooksInHandsOf5(){
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> borrowedBooksByUser = generateListOfBooks(5);
        LibraryUser libraryUser = new LibraryUser("Mikołaj", "Fabijańczuk", "890309");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(borrowedBooksByUser);
